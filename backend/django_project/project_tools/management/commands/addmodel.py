...
from ._private import APP_URLS_TEMPLATE,APP_URLS_INIT_TEMPLATE, URLS_INIT_TEMPLATE,URLS_TEMPLATE,ADMIN_INIT_TEMPLATE, ADMIN_TEMPLATE,CHANNELS_TEMPLATE, CHANNELS_INIT_TEMPLATE, MODEL_TEMPLATE, TASK_TEMPLATE, VIEW_TEMPLATE, SIGNAL_TEMPLATE, SERIALIZER_TEMPLATE, MODEL_INIT_TEMPLATE, SIGNAL_INIT_TEMPLATE, VIEW_INIT_TEMPLATE, TASK_INIT_TEMPLATE, SERIALIZER_INIT_TEMPLATE
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        modelos =[
            ...
            {
                "modulo":"routes",
                "template_in": URLS_TEMPLATE,
                "init_in": URLS_INIT_TEMPLATE
            },
            {
                "modulo":"app_routes",
